...
folders structure:
./data folder/stage folder/station folder/Reftek UnitID number/day folder/stream/reftek files
...
NOTES: you must comment the st.sort() in line 111 of /usr/local/lib64/python3.6/site-packages/obspy/io/reftek/core.py
or uncomment the line st = read(infile, component_codes=['Z', 'N', 'E'])
otherwise, the components will be fliped, because a sort utilized in obspy
